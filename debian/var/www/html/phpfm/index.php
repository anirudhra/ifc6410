<?php
//{"lang":"","fm_root":"\/mnt\/ssd-data","timezone":"","date_format":"Y\/m\/d H:i","auth_pass":"d41d8cd98f00b204e9800998ecf8427e","error_reporting":1}
/*-------------------------------------------------
| PHP FILE MANAGER
+--------------------------------------------------
...
function mb_str_ireplace($co, $naCo, $wCzym) {
    ...
    while(!is_bool($poz = mb_strpos($wCzymM, $coM, $offset))) {
        ...
        $wCzym = mb_subst2($wCzym, 0, $poz). $naCo .mb_substr($wCzym, $poz+mb_strlen($co));
        $wCzymM = mb_strtolower($wCzym);
    }
    return $wCzym;
}
...
function edit_file_form(){
    ...
    <form name=\"edit_form\" action=\"".$fm_path_info['basename']."\" method=\"post\">
        ...
        <input type=hidden name=\"file_data\" id=\"file_data\" valu=\"\">
