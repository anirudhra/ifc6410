...
A more reliable way is to copy the relevant firmware blobs to rootfs /lib/firmware (or /usr/lib/firmware) directory instead of mounting the partition everytime. Copy the contents of <repo>/custom_boot/qcom-lib-firmware/rootfs... locally on rootfs.
