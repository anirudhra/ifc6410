...
* QCOM RPM, Krait CPU/thermal management, HFPLL, QCOM-SPM, qcom kpss clock controller etc. (see Device Drivers > SoC specific drivers > QCOM SoC and Device Drivers > Common Clock Framework > QCOM clock controllers)
